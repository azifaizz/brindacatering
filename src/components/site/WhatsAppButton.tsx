...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="pointer-events-none absolute right-full mr-3 hidden whitespace-nowrap rounded-sm bg-ink px-3 py-2 text-[0.7rem] uppercase tracking-[0.14em] text-ink-foreground opacity-0 transition-opacity duration-300 group-hover:opacity-100 lg:block">
        Chat on WhatsApp
      </span>
    </a>
  );
